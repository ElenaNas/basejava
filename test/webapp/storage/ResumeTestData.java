...
public class ResumeTestData {
    ...
    public static Resume fillResume(String uuid, String fullName) {
        ...
        resume.addContact(ContactType.MOBILE_PHONE_NUMBER, "+7-909-139-64-62");
        resume.addContact(ContactType.EMAIL, "nas-elena@yandex.ru");
        resume.addContact(ContactType.SKYPE, "MySkype");
        resume.addContact(ContactType.HOME_PAGE, "MyHomePage");
        resume.addContact(ContactType.GITHUB_ACCOUNT, "https://github.com/ElenaNas");
        resume.addContact(ContactType.LINKEDIN_ACCOUNT, "www.linkedin.com/in/elena-n-a5454a2a7");
        resume.addContact(ContactType.STACKOVERFLOW_ACCOUNT, "MyStackoverflow");

        Section objectiveText = new TextSection("MyObjective");
        resume.addSection(SectionType.OBJECTIVE, objectiveText);

        Section personalText = new TextSection("My personal characteristics");
        resume.addSection(SectionType.PERSONAL, personalText);
        ...
        resume.addSection(SectionType.EXPERIENCE, workPlace1);
        ...
        resume.addSection(SectionType.EXPERIENCE, workPlace2);
        ...
        resume.addSection(SectionType.EDUCATION, eduPlace1);
        ...
        resume.addSection(SectionType.EDUCATION, eduPlace2);
