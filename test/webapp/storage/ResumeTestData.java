...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        System.out.println(fillResume(resume.getUuid(), resume.getFullName())); 
    }

    public static Resume fillResume(String uuid, String fullName) {
        Resume resume = new Resume(uuid, fullName);

        resume.setContact(ContactType.MOBILE_PHONE_NUMBER, "+7-909-139-64-62");
        resume.setContact(ContactType.EMAIL, "nas-elena@yandex.ru");
        resume.setContact(ContactType.SKYPE, "MySkype");
        resume.setContact(ContactType.HOME_PAGE, "MyHomePage");
        resume.setContact(ContactType.GITHUB_ACCOUNT, "https://github.com/ElenaNas");
        resume.setContact(ContactType.LINKEDIN_ACCOUNT, "www.linkedin.com/in/elena-n-a5454a2a7");
        resume.setContact(ContactType.STACKOVERFLOW_ACCOUNT, "MyStackoverflow");

        Section objectiveText = new TextSection("MyObjective");
        resume.setSection(SectionType.OBJECTIVE, objectiveText);

        Section personalText = new TextSection("My personal characteristics");
        resume.setSection(SectionType.PERSONAL, personalText);
        ...
        resume.setSection(SectionType.EXPERIENCE, workPlace1);
        ...
        resume.setSection(SectionType.EXPERIENCE, workPlace2);
        ...
        resume.setSection(SectionType.EDUCATION, eduPlace1);
        ...
        resume.setSection(SectionType.EDUCATION, eduPlace2);
