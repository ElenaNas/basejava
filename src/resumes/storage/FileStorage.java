...
public class FileStorage extends AbstractStorage<File> {
    ...
    private IStreamStrategy iStreamStrategy;

    public FileStorage(File fileDirectory, IStreamStrategy iStreamStrategy) {
    ...
    protected Resume doGet(File file) {
        try {
            return iStreamStrategy.doRead(new BufferedInputStream(new FileInputStream(file)));
        } catch (IOException e) {
    ...
    protected void doUpdate(Resume resume, File file) {
        try {
            iStreamStrategy.doWrite(resume, new BufferedOutputStream(new FileOutputStream(file)));
        } catch (IOException e) {
